    ...
    <div className="mt-36 mx-60 mb-20" id="about">
      ...
      <div className="flex justify-between">
        <p className="font-['system-ui'] mt-4 ml-16 text-2xl leading-loose">
          I excel in breaking down complex systems into smaller chunks, <br /> converting product requirements to technical
          plans, and <br /> designing scalable, distributed systems for startups <br />that need to scale from day 1.
        </p>
